    ...
    <Page>
      ...
      <Section>
        <div className={apple.article} lang="zh-Hant">
          ...
          <h3>如何刪除帳號？</h3>
          <p>
            在 app 裡：<strong>「我」→ 刪除帳號</strong>。它會先要求你輸入確認字。
            你的個人檔案、照片、配對紀錄和所有分享過的內容會立刻從其他使用者面前移除，並永久登出。
            我們的系統會再保留這些資料 30 天——誤刪的話，在這 30 天內寄信給我們可以復原帳號；
            30 天一到，所有資料就會從系統中完全刪除，之後無法復原。
          </p>
          <p>
            有兩件事會刻意保留：你已經傳出去的訊息，對方可能仍然看得到，
            只是會顯示為來自一個已刪除的帳號;以及如果你曾被檢舉，那筆檢舉紀錄會留存。
            其他關於你的資料的問題，請寄到{" "}
